...
void Plotdraw::paintEvent(QPaintEvent*) {
    QPainter outpainter(this);
    outpainter.drawImage(0,0, img2);
}


void Plotdraw::resizeEvent(QResizeEvent *){
    myresize();
}
void Plotdraw::myresize() {
...
Plotdraw::Plotdraw(vector<double> v1, vector<double> v2, vector<double> v3, vector<int> v4):val1(v1),val2(v2),val3(v3),events(v4)
{
     setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
     setMinimumSize(200, 200);
     n = (int)v1.size() - 1;
}
void Plotdraw::change(vector<double> v1, vector<double> v2, vector<double> v3, vector<int> v4)
{
     val1 = v1;
     val2 = v2;
     val3 = v3;
